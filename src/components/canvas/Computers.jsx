...
const ComputersCanvas = () => {
  ...
  useEffect(() => {
    ...
    const hangleMediaQueryChange = (e) => {
      setIsMobile(e.matches);
    }

    mediaQuery.addEventListener("change", hangleMediaQueryChange);
    return () => mediaQuery.removeEventListener("change", hangleMediaQueryChange);
  }, []);
